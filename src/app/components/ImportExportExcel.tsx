...
const VALID_SERVICE_TYPES = ["SKRIPSI BAB 1-3", "SKRIPSI FULL", "ARTIKEL/ JURNAL NO AKRED", "ARTIKEL / JURNAL AKRED SINTA 5-3", "MAKALAH", "PPT", "PAPER RESUM", "TUGAS RINGAN", "TUGAS LAINYA", "TUGAS UAS", "TUGAS UTS"];
